                ...
                <ul class="navbar-nav">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href="<?php echo BASE_URL ?>/pages/carousels/index">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href="<?php echo BASE_URL ?>/pages/categories/index">
                                    ...
                                    <a class="dropdown-item" href="<?php echo BASE_URL ?>/pages/galleries/index">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo BASE_URL ?>/pages/prices/index">
                            <span
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item" href="<?php echo BASE_URL ?>/pages/database/index">
